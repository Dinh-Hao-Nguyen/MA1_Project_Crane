function aux = crane(v)
   ...
   Mm = [I_tot + d6^2*m + l_B^2*m*cos(th2)^2 + (l_B^2*m_B*cos(th2)^2)/4 - d6^2*m*cos(th3)^2*cos(th4)^2 + 2*d6*l_B*m*cos(th2)*sin(th4),                         d6*l_B*m*cos(th4)*sin(th2)*sin(th3),                             l_B*m*cos(th2)*cos(th4)*sin(th3), d6*m*cos(th3)*cos(th4)*(l_B*cos(th2) + d6*sin(th4)),                -d6*m*sin(th3)*(d6 + l_B*cos(th2)*sin(th4));
